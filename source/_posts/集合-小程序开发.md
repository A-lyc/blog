...
> 复制 miniprogram_npm 到 uni-app 项目中的 dist 目录对应环境的小程序根目录下（比如 dist/dev/mp-weixin/miniprogram_npm）
> 再在 uni-app 项目 src/pages.json 中注册组件 json2canvas": "/miniprogram_npm/json2canvas/index
> 之后照常使用
